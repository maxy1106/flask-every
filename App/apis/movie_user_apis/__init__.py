...
from App.apis.movie_user_apis.movie_order_pay_api import MovieOrderPayResource
from App.apis.movie_user_apis.movie_top_api import MovieTopResource
...
user_api.add_resource(MovieOrderPayResource,'/movieorderpay/<int:id>/')
user_api.add_resource(MovieTopResource,'/movietop/')
