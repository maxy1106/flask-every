...
Revision ID: 0e9253739221
Revises: bdcf038ab8f2
Create Date: 2020-04-29 17:04:11.614304
...
revision = '0e9253739221'
down_revision = 'bdcf038ab8f2'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('o_seats', sa.String(length=256), nullable=True),
